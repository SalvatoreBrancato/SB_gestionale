...
export default function DettaglioClientePage() {
    ...
    return (
        <div className="bg-sky-50 h-full relative">
            ...
            {(form || formDestroy || formFatturaVen) && <div className={`absolute inset-x-0 top-0 bottom-0 bg-white z-10 ${form || formDestroy || formFatturaVen ? 'bg-opacity-80' : 'bg-opacity-0'}`} onClick={() => chiudiFormTrasparenza()}></div>}
            ...
            <div className="flex justify-between m-3">
                ...
                <div>
                    ...
                    <button className='me-3' onClick={() => apriChiudiForm()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#03A9F4" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#FFFFFF" className="w-7 h-7 transform hover:scale-125">
