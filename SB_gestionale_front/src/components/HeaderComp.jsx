...
export default function HeaderComp() {
    return (
        <header className="h-16 bg-[#03A9F4] flex items-center justify-around py-10">
            ...
            <div className="flex justify-around w-2/3 text-white text-lg">
                {/* DASHBOARD */}
                <Link to="/" className=" flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 transform hover:scale-125">
                ...
                {/* CLIENTI */}
                <Link to="/clienti" className=" flex flex-col items-center" >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 transform hover:scale-125">
                ...
                {/* FORNITORI */}
                <Link className=" mx-2 flex flex-col items-center" to='/fornitori'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 transform hover:scale-125">
                ...
                {/* PRODOTTI */}
                <Link className=" mx-2 flex flex-col items-center" to='/prodotti'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 transform hover:scale-125">
                ...
                {/* FATTURE ACQUISTO */}
                <Link className=" mx-2 flex flex-col items-center" to='/fatture_acquisti'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 transform hover:scale-125">
                ...
                {/* FATTURE VENDITA */}
                <Link className=" mx-2 flex flex-col items-center" to='/fatture_vendita'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 transform hover:scale-125">
