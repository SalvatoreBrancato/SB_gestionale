            ...
            <form className="mx-6 my-6" onSubmit={handleSubmit}>
                <div className="flex items-center w-full mb-5">
                    ...
                    <div className="flex w-1/3 mr-3">
                        ...
                        <select required name="cliente" id="cliente" className="w-full" value={selezioneCliente} onChange={handleClienteChange}>
                ...
                <div className="flex justify-center">
                    {isLoading ? <ClipLoader /> : <button type="submit" className="p-2 bg-sky-400 mt-3 rounded-md text-white hover:bg-blue-400">Registra nuova fattura vendita</button>}
                </div>
